...
export class ImageWeb extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={Object.assign({}, styles.container, propStyles)}>
        {src ? (
          <img
            ref={this.getImageRef}
            style={Object.assign(
              { opacity, transition, objectFit },
              styles.image
            )}
            src={src}
        ...
        {placeholderSrc ? (
          <div style={styles.placeholderContainer}>
            <img
              ...
              src={placeholderSrc}
              style={Object.assign({}, styles.placeholderImage, {
                opacity: placeholderOpacity,
                transform: this.getPlaceholderTransforms()
              })}
            />
          </div>
        ) : (
